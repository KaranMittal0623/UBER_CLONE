  ...
  return (
    <div>
        ...
        <div className='flex gap-2 justify-between flex-col items-center'>
            ...
            }} className='w-full bg-green-600 text-white font-bold p-2 rounded-xl mt-4'>Accept</button>

            <button onClick={()=>{
               props.setridePopupPanel(false)
            }} className='w-full bg-gray-600 text-white font-bold p-2 rounded-xl mt-4'>Ignore</button>
        </div>
    </div>
  )
}
